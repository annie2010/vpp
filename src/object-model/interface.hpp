...
#include <vpp/interface.api.vapi.hpp>
#include <vpp/af_packet.api.vapi.hpp>
#include <vpp/tap.api.vapi.hpp>
...
namespace VPP
{
    ...
    public:
         ...
         */
        class AFPacketdelete_cmd: public delete_cmd<vapi::Af_packet_delete>
        {
        public:
            /**
             * Constructor taking the HW::item to update
             ...
             */
            AFPacketdelete_cmd(HW::item<handle_t> &item,
                              const std::string &name);
